...
const HeaderBackground: React.FC<{ style?: object; children?: React.ReactNode }> = ({ style, children }) => {
  return (
...
const BarcodeScannerPage = () => {
  ...
  const [phoneStatus, setPhoneStatus] = useState<"in_stock" | "sold" | "with_retailer">("in_stock");
              ...
              <View style={styles.statusSelector}>
                {[
                  ...
                  <TouchableOpacity
                    ...
                    style={[
                      styles.statusOption,
                      phoneStatus === status.value && styles.statusOptionSelected,
                    ]}
                    onPress={() => setPhoneStatus(status.value as "in_stock" | "sold" | "with_retailer")}
                  >
                    <Text
                      style={[
                        styles.statusText,
                        phoneStatus === status.value && styles.statusTextSelected,
                      ]}
                    >
                      {status.label}
                    </Text>
